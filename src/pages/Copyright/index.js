    ...
    <>
        <div style={{margin:'2rem', fontFamily:'sans-serif',color:'whitesmoke'}} >
            ...
            <div>
              ...
              <p style={{margin:'0 1rem'}} > 1. File a notice, ideally by email to dmca@goTravel.com, or alternatively by mail to our Copyright Agent (see below).</p>
              <p style={{margin:'0 1rem'}} > 2. Include in the notice:</p>
              <p style={{margin:'0 3rem'}} >Your name, address, telephone number, and email address (if any). <br />A description of the allegedly infringed copyrighted work. <br />A description (ideally, a URL) of where on goTravel’s service we may find the potentially infringing material. <br />A statement of good faith belief that the use of the copyrighted work is not authorized by the copyright owner, its agent, or the law. <br />A statement that the information in your notice is accurate and that you are the copyright owner or authorized to act on the copyright owner's behalf, under penalty of perjury. <br />An electronic or physical signature.</p>
            ...
            <div>
              ...
              <p>For the fastest processing, we recommend you send notices and counter-notices by email to dmca@goTravel.com: they will be processed the more quickly, and you do not necessarily need to also send a notice by mail.</p>
            ...
            <div>
              ...
              <p>If we find that content uploaded by the same user has repeatedly caused us to receive DMCA notices, we will delete the user's account and restrict their access to goTravel using technological measures.</p>
            </div>
        </div>
        <br/>
      <hr className='hr-tag' />
